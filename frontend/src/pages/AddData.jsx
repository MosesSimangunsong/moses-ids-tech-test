        ...
        <div className="flex items-center justify-between mb-8 relative z-10">
          <div>
            ...
            <p className="text-sm text-slate-400 mt-1">
              Sistem akan membuatkan ID Transaksi otomatis.
            </p>
          </div>
          <Link
            to="/"
        ...
        <form onSubmit={handleSubmit} className="space-y-5 relative z-10" noValidate>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div className="space-y-1.5">
              ...
              <input
                ...
                name="productID"
                required
                placeholder="Misal: PRD-01"
                onChange={handleChange}
                className="w-full bg-[#0a0f1e] border border-slate-700 rounded-lg px-4 py-2.5 text-slate-200 placeholder-slate-600 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all text-sm"
              />
            </div>
            <div className="space-y-1.5">
              <label className="text-sm font-medium text-slate-300">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                required
                onChange={handleChange}
                className="w-full bg-[#0a0f1e] border border-slate-700 rounded-lg px-4 py-2.5 text-slate-200 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all text-sm"
              />
            </div>
          </div>
          ...
          <div className="pt-6 border-t border-slate-800 mt-8 flex justify-end gap-3">
            ...
            <button
              type="submit"
              disabled={loading}
              className="px-6 py-2.5 text-sm font-medium rounded-lg text-white bg-indigo-600 hover:bg-indigo-500 focus:ring-2 focus:ring-indigo-500/50 shadow-lg shadow-indigo-500/20 transition-all disabled:opacity-70 flex items-center justify-center min-w-[120px]"
            >
              {loading ? (
